...
const MUNICIPAL_PATTERN = /\b(SCH DIST|SCHOOL DIST|CNTY|COUNTY|CITY|TWN|TOWN|ST\b|STATE|AUTH|REV|MUNI|MUNICIPAL|HLTH|HOSP|UNIV|PUB IMPT|WTR|SEWER|TRANS AUTH|TRANSPORTATION AUTH|TRANSIT|TRANSN|TRANSPRTN|METROPOLITAN TRANSN|METROPOLITAN TRANSPORTATION|GO BOND|B\/E|TAX EXEMPT)\b/;
