...
export function buildTrumpOgeWorkbook(response: TrumpOgeApiResponse): XLSX.WorkBook {
  ...
  XLSX.utils.book_append_sheet(
    ...
    XLSX.utils.json_to_sheet(response.trumpIndex.map((entry) => ({
      ...
      instrument_issuer_state: entry.instrumentIssuerState || '',
      instrument_issuer_category: entry.instrumentIssuerCategory || '',
  ...
  XLSX.utils.book_append_sheet(
    ...
    XLSX.utils.json_to_sheet(response.transactions.map((tx) => ({
      ...
      instrument_issuer_state: tx.instrumentIssuerState || '',
      instrument_issuer_category: tx.instrumentIssuerCategory || '',
  ...
  XLSX.utils.book_append_sheet(
    ...
    XLSX.utils.json_to_sheet(response.holdingsEstimates.map((holding) => ({
      ...
      instrument_issuer_state: holding.instrumentIssuerState || '',
      instrument_issuer_category: holding.instrumentIssuerCategory || '',
  ...
  XLSX.utils.book_append_sheet(
    ...
    XLSX.utils.json_to_sheet(response.securityEnrichments.map((item) => ({
      ...
      instrument_issuer_state: item.instrumentIssuerState || '',
      instrument_issuer_category: item.instrumentIssuerCategory || '',
